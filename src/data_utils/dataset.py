...
class Sun3DBaseDataset(Dataset):
    ...
    """
    def __init__(self, data_root, sequences, split='train', transform=None, predict=False):
        """
...
class DatasetSplitter:
    ...
    """
    @staticmethod
    def get_train_test_sequences(predict=False):
        """
        ...
        if predict is False:
            ...
            train_sequences = ['mit_32_d507',]
            test_sequences = ['ucl_data',]
